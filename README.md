# Fm Sarkar — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-fm-sarkar/
- **Repo:** `shreekantha3/sindagi-fm-sarkar` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-fm-sarkar/'` for GitHub Pages project-site hosting.
